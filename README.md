...
2. **Install Dependencies:**
   ...
   ```bash
   npm install --force user-agents axios colors p-limit https-proxy-agent socks-proxy-agent qs 
   ```
...
- **Help me with your referral** [Referral Link](https://t.me/GccAirdrop_bot/AirdropTraffic?startapp=qeip4J_en)
